...
import com.fashio.apps.Session.COD_Session;
import com.fashio.apps.Session.Shipment_Session;
import com.google.android.gms.ads.AdView;
import com.fashio.apps.Activities.Full_Image;
import com.fashio.apps.Activities.Main_Handler_Activity;
import com.fashio.apps.Adapters.Cat_Image_Adapter;
...
public class Fragment_Refresh extends Fragment {
    ...
    private static final String DATA_URL = "https://apps.itrifid.com/fashio/rest_server/firstContent/API-KEY/123456";
                        ...
                        try {
                            ...
                            if (status.equals("200")){
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    String rate_count = jsonObject.getString("rae_count");
                                    Boolean isLiked = jsonObject.getBoolean("isLiked");
                                    String img_url = properties.getString("original_img_dest");
                                    String img_id = properties.getString("img_id");
                                    String price = properties.getString("selling_price");
