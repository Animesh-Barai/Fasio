...
import com.fashio.apps.Adapters.Notification_Adapter;
import com.fashio.apps.Applications.AppController;
import com.fashio.apps.Model.Notification;
import com.fashio.apps.R;


public class Notifications_Activity extends Activity {

    private static final String NOTIFICATION_URL = "https://apps.itrifid.com/fashio/rest_server/getAllNotification/API-KEY/123456";
