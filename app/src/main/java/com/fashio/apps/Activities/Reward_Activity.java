...
import com.fashio.apps.Adapters.Reward_Adapter;
import com.fashio.apps.Applications.AppController;
import com.fashio.apps.Model.Reward;
...
public class Reward_Activity extends AppCompatActivity {
    ...
    private static final String REWARD_URL = "https://apps.itrifid.com/fashio/rest_server/userCoupon/API-KEY/123456";
